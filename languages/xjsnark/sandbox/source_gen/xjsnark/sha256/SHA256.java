    ...
    this.__evaluateSampleRun(new SampleRun("Sample_Run1", true) {
      ...
      public void post() {
        ...
        for (int i = 0; i < digest.length; i++) {
          System.out.println(digest[i].getValueFromEvaluator(CircuitGenerator.__getActiveCircuitGenerator().__getCircuitEvaluator()).toString(16));
        }
      }
